...
| D6 | `buildMarketStory` / `marketMap` hero synthesis | DerivedNarrative + The Read thesis | P2.2 |
...
| D9 | watch/driver derivation in two homes (`themeTransmission` + `intelligenceDeltas`) | itself | consolidate in P2.2 (one exported home; the other imports) |
